        ...
        <div className="mt-8 container mx-auto h-full">
            <div className="mb-8 bg-blue-100 border-t-4 border-blue-500 rounded-b text-blue-900 px-4 py-3 shadow-md" role="alert">
                <div className="flex">
                    ...
                    <div>
                    <p className="font-bold">Usuários cadastrados</p>
            ...
            <div className="bg-white border-t-4 border-purple-500 rounded-b px-4 py-3 shadow-md">
                <div className="table w-full">
                    <div className="table-row">
                        ...
                        <div className="table-cell bg-gray-800 text-white px-4 py-2 text-sm">E-mail</div>
                        <div className="table-cell bg-gray-800 text-white px-4 py-2 text-sm">Data de registro</div>
                        <div className="table-cell bg-gray-800 text-white px-4 py-2 text-sm">Ações</div>
                    </div>
                    <div className="table-row">
                        <div className="table-cell bg-gray-400 text-gray-700 px-4 py-2 text-sm">João da Silva</div>
                        <div className="table-cell bg-gray-400 text-gray-700 px-4 py-2 text-sm">joaodasilva@discord.com</div>
                        <div className="table-cell bg-gray-400 text-gray-700 px-4 py-2 text-sm">19/02/2019</div>
                        <div className="block table-cell bg-gray-400 text-gray-700 px-4 py-2 text-sm text-center font-semibold">
                            <Link to="/users/:id/edit">Editar</Link> { /** Edit actions */}
                            <Link to="/users/:id/delete">Excluir</Link>
                        </div>
                    </div>
                    <div className="table-row">
                        <div className="table-cell bg-gray-200 text-gray-700 px-4 py-2 text-sm">Cell 4</div>
                        <div className="table-cell bg-gray-200 text-gray-700 px-4 py-2 text-sm">A cell with more content</div>
