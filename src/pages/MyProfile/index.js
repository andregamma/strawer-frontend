...
export default class MyProfilePage extends Component {
    componentDidMount(){
        API.get('/users', { headers: {"authorization" : `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MywibG9naW4iOiJhbmRyZWdhbW1hIiwiaWF0IjoxNTc0MDgwMDAwLCJleHAiOjE1NzQwOTQ0MDB9.qOLuScBWm66EW5tKh9mvOuZe-ueZJm8L2XjkhtuEY5M`}, id: "3" })
            .then((res) => {           
                console.log(res)
            })
            .catch((e) => {
  ...
  render() {
    return (
        <section id="my-profile-page" className="container mx-auto mt-20">
            ...
            <div className="bg-white rounded shadow-lg mt-8 w-full px-4 py-4">
              a
            </div>
          </div>
        </section>
