                ...
                <div className="container mx-auto">
                    <div className="flex mb-4">
                        ...
                        <div className="w-3/6 h-104 my-4 mx-4 bg-white rounded-lg">
                            <figure>
                                <img className="bg-cover" src="https://1.bp.blogspot.com/-mpM4cTsYV78/VkVj1A5sN_I/AAAAAAAAErc/yWVqQayuEis/s1600/f3r.png" alt=""/>
                            </figure>
                        </div>
                        <div className="w-full my-4 mx-4">
                            <nav className="text-black font-bold my-2" aria-label="Breadcrumb">
                                <ol className="list-none p-0 inline-flex">
                                    ...
                                    <li>
                                        <a href="#" className="text-gray-500" aria-current="page">Script para MTA</a>
                                    </li>
                                </ol>
                            </nav>
